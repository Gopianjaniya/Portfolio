        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="flex flex-col gap-4">
            {skillsLeft.map((skill, index) => (
              <div
                key={skill}
                className={`group flex items-center justify-between px-6 py-4 rounded-2xl transition text-white font-semibold hover:font-bold hover:bg-orange-500 bg-neutral-900 hover:text-black hover:scale-107`}
              >
                <span>{skill}</span>
