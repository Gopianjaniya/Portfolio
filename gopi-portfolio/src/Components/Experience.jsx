  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        {/* Experience Card */}
        <div
          className="bg-linear-to-r from-[#141414] to-[#202020] rounded-3xl p-8 md:p-10 flex flex-col md:flex-row gap-8 relative  transition-all duration-300 ease-in-out
    hover:scale-102
    ...
    hover:shadow-lg"
              ...
              <div>
                <h3 className="font-semibold text-2xl">4Brains Software LLP</h3>
          ...
          <div className="md:w-3/4">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4">
              <div>
                ...
                <p className="text-gray-400 text-lg font-semibold flex items-center gap-1">
                  📍 India
                </p>
              </div>
            ...
            {/* Description */}
            <p className="text-gray-300 leading-relaxed mb-6 font-semibold text-lg">
